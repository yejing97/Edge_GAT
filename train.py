...
parser.add_argument('--config_name', type=str, default = 'full_structure')
...
if __name__ == '__main__':
    ...
    trainer = pl.Trainer(max_epochs = cfg['epoch'], accelerator="auto", devices=1, logger=logger,reload_dataloaders_every_n_epochs=1)
